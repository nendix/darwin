...
def clamp_to_bounds(x: float, y: float, w: int, h: int, radius: float = 5.0) -> Tuple[float, float]:
...
def check_collision(agent1_pos: Tuple[float, float], agent2_pos: Tuple[float, float], 
                   min_distance: float = 8.0) -> bool:
...
def resolve_collision(agent_pos: Tuple[float, float], other_pos: Tuple[float, float], 
                     min_distance: float = 8.0) -> Tuple[float, float]:
