...
class EvolutionEngine:
    ...
    def evolve_prey_population(
        ...
        while len(next_generation) < target_population:
            parent1 = tournament_select(sorted_genomes, sorted_fitness, params.tournament_k)
            parent2 = tournament_select(sorted_genomes, sorted_fitness, params.tournament_k)
